...
import com.hairdress.bean.Logging;
import com.hairdress.dao.LoggingDao;
import com.hairdress.dao.UserLocationDao;
import com.hairdress.model.Article;
import com.hairdress.model.BaiduPlace;
import com.hairdress.model.Music;
import com.hairdress.model.MusicMessage;
import com.hairdress.model.NewsMessage;
import com.hairdress.model.TextMessage;
import com.hairdress.model.UserLocation;
import com.hairdress.util.BaiduMapUtil;
import com.hairdress.util.MessageUtil;
		...
		try {
			...
			if (msgType.equals(MessageUtil.MESSAGE_TYPE_TEXT)) {
				...
				// 多图文消息---最后一条消息不含图片
					...
					Article article3 = new Article();
					article3.setTitle("如果您对本订阅号有什么想法或者建议，欢迎联系我：coldxiangyu！");
					article3.setDescription("");
					// 将图片置为空
					article3.setPicUrl("");
					article3.setUrl("https://www.zybuluo.com/coldxiangyu");
