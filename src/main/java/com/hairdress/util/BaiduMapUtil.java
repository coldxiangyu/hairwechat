...
public class BaiduMapUtil {
	...
	public static List<BaiduPlace> searchPlace(String query, String lng, String lat) throws Exception {
		// 拼装请求地址
		String requestUrl = "http://api.map.baidu.com/place/v2/search?&query=QUERY&location=LAT,LNG&radius=2000&output=xml&scope=2&page_size=10&page_num=0&ak=R46500oYHx3GOC5bGXkOishFAI4EbEA1";
	...
	public static Map<String,Double> getLngAndLat(String address){
        ...
        String url = "http://api.map.baidu.com/geocoder/v2/?address="+address+"&output=json&ak=R46500oYHx3GOC5bGXkOishFAI4EbEA1";
	...
	public static void main(String[] args) throws Exception{
		Map<String,Double> map = getLngAndLat("北京市国贸");
        System.out.println("经度："+map.get("lng")+"---纬度："+map.get("lat"));
		List<BaiduPlace> placeList = searchPlace("理发店",map.get("lng")+"",map.get("lat")+"");
		BaiduPlace place = null;
		for (int i = 0; i < placeList.size(); i++) {
			place = placeList.get(i);
